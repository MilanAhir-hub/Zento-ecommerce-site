            ...
            <div className="max-w-[440px] w-full bg-white p-8 sm:p-12 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-stone-100">
                <div className="mb-10 text-center">
                    ...
                    <p className="mt-3 text-[15px] font-medium text-stone-500">
                        ...
                        <Link to="/login" className="text-stone-900 font-bold hover:text-stone-700 transition-colors">
                            Log in
                        </Link>
                    </p>
                </div>
                ...
                <form className="space-y-6" onSubmit={handleSignup}>
                    ...
                    <div className="space-y-5">
                        {/* Name Input */}
                        <div>
                            <label htmlFor="full-name" className="block text-xs font-bold text-stone-400 uppercase tracking-widest mb-2 pl-1">
                                Full Name
                            </label>
                            <input
                                id="full-name"
                        ...
                        <div>
                            <label htmlFor="password" className="block text-xs font-bold text-stone-400 uppercase tracking-widest mb-2 pl-1">
                                Password
                            </label>
