    ...
    return (
        <div className="min-h-screen grid grid-cols-1 lg:grid-cols-2 bg-white text-[#222222] font-sans selection:bg-[#000000] selection:text-white">
            ...
            <div className="hidden lg:block relative h-full w-full bg-stone-100 overflow-hidden">
                <img
                    src="https://img.magnific.com/free-photo/young-woman-with-shopping-bags-beautiful-dress_1303-17550.jpg?t=st=1780573404~exp=1780577004~hmac=c586d840dd6a9043474428ee595a7828205c42d40aa1ea4d5153f871fabc5945&w=1480"
                ...
                <div className="w-full max-w-[420px] pt-12 lg:pt-0">
                    ...
                    <div className="text-center mt-6 text-[12px]">
                        <p className="text-[#767676]">
                            ...
                            <Link
                                to="/login"
                                className="text-[#222222] hover:text-black underline underline-offset-4 font-medium ml-1"
                            >
                                Sign In
                            </Link>
                        </p>
