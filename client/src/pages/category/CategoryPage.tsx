...
const FocusProductCard = ({ product }: { product: Product }) => {
    return (
        <div className="lg:col-span-6 md:col-span-2 bg-[#F9F9F9] p-6 lg:p-8 flex flex-col justify-between h-full group relative">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center h-full">
                ...
                <div className="flex flex-col justify-between h-full py-4 pl-0 md:pl-6">
                    <div>
                        <span className="text-[10px] font-medium uppercase tracking-[0.25em] text-gray-400 block mb-3">
                            Key Silhouette
                        </span>
                        <h3 className="text-[20px] font-light uppercase tracking-[0.08em] text-black leading-snug mb-4">
                            Selected Drape
                        </h3>
                        <p className="text-[13px] text-gray-600 leading-relaxed font-normal mb-6">
                    ...
                    <div className="pt-4 border-t border-gray-200">
                        <span className="text-[10px] font-medium uppercase tracking-[0.15em] text-black block mb-2">
                            Styling Notes
                        </span>
                        <p className="text-[12px] text-gray-500 italic font-light leading-relaxed">
...
const FullWidthProductCard = ({ product }: { product: Product }) => {
    return (
        <div className="lg:col-span-12 bg-[#F9F9F9] p-6 lg:p-10 flex flex-col md:flex-row gap-8 items-center justify-between group">
            <div className="flex-1 max-w-lg">
                <span className="text-[10px] font-medium uppercase tracking-[0.25em] text-gray-400 block mb-3">
                    Seasonal Highlight
                </span>
                <h3 className="text-[24px] font-light uppercase tracking-[0.08em] text-black mb-3">
                ...
                <div className="text-[12px] text-gray-400 font-light italic">
                    "Designed to stand alone or act as the grounding layer under structured seasonal coats."
                </div>
            </div>
            <div className="w-full md:w-[320px] bg-white p-4 shrink-0">
                <ProductCard product={product} />
            </div>
        </div>
    );
...
const CategoryPage = () => {
    ...
    if (isError) {
        return (
            <div className="min-h-[80vh] flex flex-col items-center justify-center text-center px-6 bg-white">
                ...
                <h2 className="text-2xl font-normal text-gray-900">Something went wrong.</h2>
                <p className="mt-2 text-gray-500 max-w-sm mb-8">We couldn't load the products for this category. Please try again later.</p>
                <Link to="/" className="text-black font-medium hover:underline flex items-center gap-1 uppercase tracking-[0.12em] text-xs">
                    Go back to home
    ...
    return (
        <div className="w-full bg-white min-h-screen font-sans">
            ...
            {/* Category Hero Block */}
            <header className="max-w-[1440px] mx-auto px-4 md:px-10 py-12 md:py-16">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
                    ...
                    <div>
                        ...
                        <nav className="flex items-center text-[11px] font-medium text-gray-400 mb-6 tracking-[0.12em] uppercase">
                            <Link to="/" className="hover:text-black transition-colors duration-200 ease-[cubic-bezier(0.4,0,0.2,1)]">Home</Link>
                            <HugeiconsIcon icon={ArrowRight01Icon} size={10} className="mx-2 opacity-40" />
                            <Link to={`/category/${name}`} className="hover:text-black transition-colors duration-200 ease-[cubic-bezier(0.4,0,0.2,1)]">{name}</Link>
                            {subCategory && (
                                <>
                                    <HugeiconsIcon icon={ArrowRight01Icon} size={10} className="mx-2 opacity-40" />
                        ...
                        <p className="text-[14px] text-[#767676] max-w-lg leading-relaxed mb-8 font-normal">
                            {editorial.storytellingText}
                        </p>

                        {/* Editorial Quote */}
                        <blockquote className="text-[16px] text-gray-500 italic font-light leading-relaxed mb-8 pl-4 border-l border-gray-300">
                    ...
                    <div className="relative h-[260px] sm:h-[350px] lg:h-[450px] bg-stone-100 overflow-hidden group select-none">
                        <img
                            src={heroImg}
                            alt={`${name} collection cover`}
                            className="absolute inset-0 w-full h-full object-cover transition-opacity duration-200 ease-[cubic-bezier(0.4,0,0.2,1)] group-hover:opacity-90"
                        />
            ...
            <main className="w-full py-12">
                {isLoading ? (
                    ...
                    <div className="text-center py-24 px-6 max-w-md mx-auto">
                        <p className="text-[18px] text-[#767676] font-normal italic mb-4">No results found for your search.</p>
                        <button
                    ...
                    <div className="space-y-24">
                        ...
                        <section className="max-w-[1440px] mx-auto px-4 md:px-10">
                            <h2 className="text-[11px] font-medium uppercase tracking-[0.25em] text-[#767676] mb-8 text-center md:text-left">
                                Featured Mosaic
                            </h2>
                        ...
                        <section className="w-full relative h-[380px] md:h-[500px] bg-stone-900 overflow-hidden select-none group">
                            <img
                                ...
                                alt={`${name} Campaign`}
                                className="absolute inset-0 w-full h-full object-cover opacity-85 transition-opacity duration-200 ease-[cubic-bezier(0.4,0,0.2,1)] group-hover:opacity-80"
                            />
                            <div className="absolute inset-0 bg-gradient-to-t from-black/40 via-black/10 to-transparent" />
                            <div className="absolute inset-0 flex flex-col justify-center items-center text-center px-6">
                                <span className="text-[11px] font-medium uppercase tracking-[0.35em] text-white/80 mb-4">
                                    Campaign Editorial
                                </span>
                                <h2 className="text-[32px] md:text-[52px] font-light tracking-[0.08em] text-white uppercase max-w-2xl leading-[0.95] mb-4">
                                    {editorial.campaignTitle}
                                </h2>
                                <p className="text-[11px] md:text-[13px] font-medium text-white/90 uppercase tracking-[0.2em] max-w-lg border-t border-white/20 pt-4">
                        ...
                        {grid1Products.length > 0 && (
                            <section className="max-w-[1440px] mx-auto px-4 md:px-10">
                                <div className="pb-4 mb-8 flex items-baseline justify-between">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 items-center">
                                ...
                                <div className="relative aspect-[3/4] bg-stone-100 overflow-hidden group select-none">
                                    ...
                                    <div className="absolute bottom-6 left-6 right-6 text-white">
                                        <span className="text-white text-[10px] font-medium uppercase tracking-[0.25em] block mb-1 opacity-70">
                                            Detail Focus
                                        </span>
                                        <p className="text-white text-[18px] font-light tracking-[0.05em] uppercase leading-tight">
                                            Art of Drape
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="flex flex-col justify-between h-full py-6 md:py-8">
                                    <div className="max-w-md mb-8">
                                        ...
                                        <p className="text-[13px] text-gray-500 leading-relaxed font-normal mb-8">
                                            {editorial.storytellingText}
                                        </p>
                                    </div>
                                ...
                                <div className="max-w-[1440px] mx-auto px-4 md:px-10">
                                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-start">
                                        ...
                                        <div className="lg:col-span-4 flex flex-col justify-between min-h-[350px]">
                                            <div>
                                                <span className="text-[10px] font-medium uppercase tracking-[0.25em] text-[#767676] mb-3 block">
                                                    Curated Selection
                                                </span>
                                                <h3 className="text-[28px] font-light tracking-[0.05em] text-black uppercase mb-6 leading-tight">
                                                    Editor's Picks
                                                </h3>
                                                <p className="text-[14px] text-[#222222] leading-relaxed mb-6 font-normal">
                                            ...
                                            <div className="pt-6 mt-auto border-t border-gray-200">
                                                <span className="text-[11px] font-medium uppercase tracking-[0.12em] text-black block mb-1">
                                                    Sartorial Direction
                                                </span>
                                        ...
                                        <div className="lg:col-span-8 grid grid-cols-1 sm:grid-cols-3 gap-6 lg:gap-8">
                                            {editorsPicks.slice(0, 3).map((product) => (
                                                <div key={product._id} className="bg-white p-4 relative group">
                                                    <div className="absolute top-6 left-6 z-10 bg-black text-white text-[9px] font-medium uppercase tracking-[0.12em] px-2 py-0.5">
                                                        Editor's Choice
                                                    </div>
                                                    <ProductCard product={product} />
                                                </div>
                                    ...
                                    {editorsPicks.length === 4 && (
                                        <div className="mt-8 pt-8 flex justify-end">
                                            <div className="w-full lg:w-2/3 grid grid-cols-1 sm:grid-cols-2 gap-6 lg:gap-8 items-center bg-white p-6">
                                                <div>
                                                    <span className="text-[10px] font-medium uppercase tracking-[0.25em] text-gray-400 block mb-1">
                                                        Featured Core Choice
                                                    </span>
                                                    <h4 className="text-[18px] font-light uppercase tracking-[0.08em] text-black mb-3">
                                                        The Tailoring Icon
                                                    </h4>
                                ...
                                <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-stretch">
                                    ...
                                    <div className="lg:col-span-5 relative min-h-[450px] bg-stone-100 overflow-hidden group select-none">
                                        <img
                                            ...
                                            className="absolute inset-0 w-full h-full object-cover transition-opacity duration-200 ease-[cubic-bezier(0.4,0,0.2,1)] group-hover:opacity-90"
                                        />
                                        <div className="absolute inset-0 bg-black/10 transition-opacity duration-200 ease-[cubic-bezier(0.4,0,0.2,1)] group-hover:bg-black/15" />
                                        <div className="absolute bottom-8 left-8 right-8 text-white">
                                            <span className="text-[10px] font-medium uppercase tracking-[0.3em] block mb-2 opacity-80">
                                                Styling Atelier
                                            </span>
                                    ...
                                    <div className="lg:col-span-7 flex flex-col justify-between py-2">
                                        <div className="mb-8 pb-6 flex items-baseline justify-between border-b border-gray-200">
                                            <div>
                                                <span className="text-[10px] font-medium uppercase tracking-[0.2em] text-[#767676] block mb-1">
                                                    Complete the Look
                                                </span>
                                            ...
                                            <span className="text-[11px] font-medium text-gray-400 uppercase tracking-[0.12em] hidden sm:inline">
                                                Outfit Coordinates
                                            </span>
                                        </div>
                                        ...
                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 lg:gap-8">
                                            {lookbookProducts.map((product, idx) => (
                                                <div key={product._id} className="relative">
                                                    <div className="absolute top-3 left-3 z-10 bg-white/90 backdrop-blur-sm text-black text-[9px] font-medium uppercase tracking-[0.12em] px-2 py-0.5">
                                                        Piece {idx === 0 ? "One" : "Two"}
                                                    </div>
                                                    <ProductCard product={product} />
                                                </div>
                        ...
                        <section className="w-full relative h-[280px] md:h-[350px] bg-stone-950 overflow-hidden select-none flex items-center justify-center">
                            <div className="absolute inset-0 bg-[#F9F9F9]" />
                            <div className="relative text-center px-6 max-w-xl">
                                <span className="text-[10px] font-medium uppercase tracking-[0.4em] text-gray-400 block mb-4">
                                    Novara Capsule
                                </span>
                                <h2 className="text-[24px] md:text-[36px] font-light tracking-[0.08em] text-black uppercase leading-tight mb-4">
                                ...
                                <div className="inline-block border-b border-black text-[11px] font-medium uppercase tracking-[0.2em] text-black hover:border-transparent transition-colors duration-200 ease-[cubic-bezier(0.4,0,0.2,1)] cursor-pointer pb-0.5">
                        ...
                        {remainingProducts.length > 0 && (
                            <section className="max-w-[1440px] mx-auto px-4 md:px-10">
                                <div className="pb-4 mb-8">
                                    <h2 className="text-[11px] font-medium uppercase tracking-[0.25em] text-[#767676]">
                                        More to Discover
                                    </h2>
                                </div>
                                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-6 gap-y-12">
                    ...
                    <div className="max-w-[1440px] mx-auto px-4 md:px-10">
                        {hasSearchActive && (
                            <div className="pb-4 mb-8">
                                <h2 className="text-[11px] font-medium uppercase tracking-[0.25em] text-gray-400">
            ...
            {!isLoading && products.length > 0 && (
                <div className="max-w-[1440px] mx-auto px-4 md:px-10 py-12 text-center">
                    <div className="h-px bg-gray-200 mb-8" />
                    <span className="text-[11px] font-medium uppercase tracking-[0.3em] text-[#767676]">
